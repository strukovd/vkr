...
exports.kkHandler = async function(form) {
	log.debug(`Вызван метод kkHandler`);
	...
	try {
		...
		*/
		...
		log.error(`В методе kkHandler, возникла ошибка!`, err);
...
async function prepareBody(formData) {
	...
	const body = {
		"fields": {
			...
			issuetype: { "id": "13602" }, //Oформление клиента
	...
	body.fields['customfield_15100'] = { id: formData["SK_type"] } || ''; // Тип СК
