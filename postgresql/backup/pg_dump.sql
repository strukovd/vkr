...
COPY public.projects (key, name, "desc") FROM stdin;
...
COPY public.tasks (id, key, title, "desc", priority, assignee, creator, updated, created, project_key) FROM stdin;
...
COPY public.transitions (id, project_id, task_type_id, name, from_status, to_status) FROM stdin;
\.
